...
def get_dataset(
    ...
    if config.data.dataset.upper() == "CIFAR10":
        ...
        train_ds = CIFAR10("/workspace/datasets", train=True, download=True, transform=transforms)
        eval_ds = CIFAR10("/workspace/datasets", train=False, download=True, transform=transforms)
